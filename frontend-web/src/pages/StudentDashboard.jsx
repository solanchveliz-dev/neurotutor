    ...
    <div className={styles.container}>
      <div className={styles.topBar}>
        ...
        <nav className={styles.menuLinks}>
          <button className={styles.menuLink}>Inicio</button>
          <button className={styles.menuLink}>Módulos</button>
          <button className={styles.menuLink}>Progreso</button>
        </nav>
      ...
      <section className={styles.modulesSection}>
        ...
        <div className={styles.modulesGrid}>
          {modules.map((module) => {
            const percentage = Math.round((module.progress / module.total) * 100);
